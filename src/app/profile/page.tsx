...
export default function ProfilePage() {
  return (
    <div style={{ minHeight: "100vh", padding: "200px 60px 60px" }}>
      <header style={{ position: "fixed", top: 0, left: 0, width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", padding: "40px 60px", background: "rgba(5,5,5,0.9)", backdropFilter: "blur(10px)", zIndex: 100 }}>
      ...
      <main style={{ maxWidth: "800px", margin: "0 auto", background: "rgba(255,255,255,0.02)", padding: "50px", borderRadius: "30px", border: "1px solid #1a1a1a" }}>
        ...
        <p style={{ color: "#666" }}>Zalogowano pomyślnie. Edycja profilu wkrótce.</p>
      </main>
    </div>
  );
}
