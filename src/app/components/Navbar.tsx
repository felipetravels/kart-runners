...
export default function Navbar() {
  ...
  return (
    <nav style={{ 
      ...
      padding: "40px 60px", background: "rgba(0,0,0,0.9)", backdropFilter: "blur(15px)",
      ...
      <div style={{ display: "flex", gap: "35px", alignItems: "center" }}>
        ...
        {user ? <a href="/profile" style={btn}>PROFIL</a> : <a href="/login" style={{...btn, background: "#fff", color: "#000"}}>ZALOGUJ</a>}
      </div>
    </nav>
  );
}
const l = { color: "#fff", textDecoration: "none", fontSize: "1rem", fontWeight: 900, letterSpacing: "1px" };
const btn = { color: "#00d4ff", border: "2px solid #00d4ff", padding: "12px 30px", borderRadius: "14px", textDecoration: "none", fontWeight: 900 };
